...
`results/sample_report.json` is generated by the runner and intentionally ignored by git.

Future benchmark dimensions may add additional synthetic suites for accountability completeness, adversarial robustness, identity stability, and epistemic calibration.
